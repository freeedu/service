...
public class OAuth2ClientDetailsService implements ClientDetailsService, ClientRegistrationService {
	...
	public void addClientDetails(ClientDetails clientDetails) throws ClientAlreadyExistsException {
		try {
			...
			feopClientDetailService.createApplication(oauthClientDetail);
	...
	public void updateClientDetails(ClientDetails clientDetails) throws NoSuchClientException {
		OauthClientDetail oauthClientDetail = feopClientDetailService.findByClientId(clientDetails.getClientId());
		if (oauthClientDetail == null) {
			throw new NoSuchClientException("No client found with id = " + clientDetails.getClientId());
		}

		setOrUpdateClientDetails(oauthClientDetail, clientDetails);
		feopClientDetailService.updateApplication(oauthClientDetail);
	}

	@Override
	public void updateClientSecret(String clientId, String secret) throws NoSuchClientException {
		OauthClientDetail oauthClientDetail = feopClientDetailService.findByClientId(clientId);
		if (oauthClientDetail == null) {
	...
	public void removeClientDetails(String clientId) throws NoSuchClientException {
		...
		feopClientDetailService.deleteApplication(oauthClientDetail);
	}

	@Override
	public List<ClientDetails> listClientDetails() {
		List<OauthClientDetail> allClients = feopClientDetailService.findAllOauthClientDetails();
