...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		<form action="${update }" method="post" class="form-horizontal" name="userForm">
			...
			<div class="form-group">
				<label class="left">User Name:</label><input type="text" name="userName" class="form-control" value="${userForm.userName}" />
			</div>
			<div class="form-group">
				<label class="left">Email:</label><input type="text" name="email" disabled="disabled" class="form-control" value="${userForm.email}" />
			</div>
			<div class="form-group">
				<label class="left">Phone:</label><input type="text" name="phone" class="form-control" value="${userForm.phone }" />
			</div>
