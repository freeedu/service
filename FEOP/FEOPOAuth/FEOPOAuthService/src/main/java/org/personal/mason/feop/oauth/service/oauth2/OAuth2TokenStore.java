...
public class OAuth2TokenStore implements TokenStore {
	...
	private OAccessTokenService accessTokenService;
	private ORefreshTokenService refreshTokenService;

	@Autowired
	public void setAccessTokenService(OAccessTokenService accessTokenDao) {
		if (accessTokenDao == null) {
			throw new IllegalArgumentException("access Token Service cannot be null");
		}
		this.accessTokenService = accessTokenDao;
	}

	@Autowired
	public void setRefreshTokenService(ORefreshTokenService refreshTokenDao) {
		if (refreshTokenDao == null) {
			throw new IllegalArgumentException("refresh Token Service cannot be null");
		}
		this.refreshTokenService = refreshTokenDao;
	}
	...
	public OAuth2Authentication readAuthentication(String token) {
		...
		try {
			OauthAccessToken accessToken = accessTokenService.findAccessTokenWithTokenId(extractTokenKey(token));
	...
	public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
		...
		accessTokenService.saveObject(accessToken);
	}
	...
	public OAuth2AccessToken readAccessToken(String tokenValue) {
		...
		try {
			...
			OauthAccessToken token = accessTokenService.findAccessTokenWithTokenId(extractTokenKey(tokenValue));
	...
	public void removeAccessToken(String tokenValue) {
		accessTokenService.removeAccessTokenByTokenId(extractTokenKey(tokenValue));
	}
	...
	public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
		...
		refreshTokenService.saveObject(token);
	}
	...
	public OAuth2RefreshToken readRefreshToken(String tokenValue) {
		...
		try {
			OauthRefreshToken token = refreshTokenService.findRefreshTokenWithTokenId(extractTokenKey(tokenValue));
	...
	public OAuth2Authentication readAuthenticationForRefreshToken(String value) {
		...
		try {
			OauthRefreshToken refreshToken = refreshTokenService.findRefreshTokenWithTokenId(extractTokenKey(value));
	...
	public void removeRefreshToken(String token) {
		refreshTokenService.removeRefreshTokenByTokenId(extractTokenKey(token));
	}
	...
	public void removeAccessTokenUsingRefreshToken(String refreshToken) {
		accessTokenService.removeAccessTokenByRefreshToken(extractTokenKey(refreshToken));
	}
	...
	public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
		...
		try {
			OauthAccessToken token = accessTokenService.findAccessTokenWithAuthenticationId(key);
	...
	public Collection<OAuth2AccessToken> findTokensByUserName(String userName) {
		...
		try {
			List<OauthAccessToken> tokens = accessTokenService.findAccessTokenWithUsername(userName);
	...
	public Collection<OAuth2AccessToken> findTokensByClientId(String clientId) {
		...
		try {
			List<OauthAccessToken> tokens = accessTokenService.findAccessTokenWithClientId(clientId);
			for (OauthAccessToken token : tokens) {
				if (token.getToken() != null) {
					accessTokens.add(deserializeAccessToken(token.getToken()));
				}
