...
<div class=" col-md-8 col-md-offset-2">
    ...
    <form action="${update }" method="post" class="form-horizontal" name="template">
        ...
        <div class="form-group">
            <label for="subject">Subject:</label><input id="subject" type="text" value="${template.subject }" name="subject"
                                                        disabled="disabled" class="form-control"/>
        </div>
        <div class="form-group">
            <label for="version">Version:</label><input id="version" type="text" value="${template.version }" name="version"
