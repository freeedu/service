		...
		<div class="navbar-collapse collapse">
			<sec:authorize ifAllGranted="ROLE_USER">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="<c:url value="/account/"/>" class="dropdown-toggle" data-toggle="dropdown">Profile<b class="caret"></b></a>
					...
					<sec:authorize ifAllGranted="ROLE_USER" access="hasRole('ROLE_DEV')">
						<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="<c:url value="/client/list"/>">Applications<b
								class="caret"></b></a>
							<ul class="dropdown-menu">
					...
					<sec:authorize ifAllGranted="ROLE_USER" access="hasRole('ROLE_ADMIN')">
						<li class="dropdown"><a href="<c:url value="/admin/et/list"/>" class="dropdown-toggle" data-toggle="dropdown">Template<b
								class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/admin/et/list"/>">Templates</a></li>
								<li><a href="<c:url value="/admin/et/new"/>">New Template</a></li>
							</ul></li>
						<li class="dropdown"><a href="<c:url value="/admin/settings/list"/>" class="dropdown-toggle" data-toggle="dropdown">Settings<b
								class="caret"></b></a>
							<ul class="dropdown-menu">
