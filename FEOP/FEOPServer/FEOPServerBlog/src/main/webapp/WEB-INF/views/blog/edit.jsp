...
<c:if test="${blog != null }">
	...
	<form role="form" class="form-horizontal well" action='<c:url value="/my/blog/create"/>' method="post">
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input class="form-control" name="blogTitle" type="text" placeholder="Title" value="${blog.blogTitle }" required>
			</div>
		</div>
		<div class="form-group">
			<label class="col-lg-2 control-label" for="blogSubtitle">Subtitle</label>
			<div class="col-lg-10">
				<input class="form-control" type="text" name="blogSubtitle" placeholder="Subtitle" value="${blog.blogSubtitle }">
			</div>
		</div>
		<fieldset disabled>
			<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input name="category.id" id="category-value" type="hidden" value="${blog.category.id }"> <select class="form-control" id="category"
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input name="sery.id" id="sery-value" type="hidden" value="${blog.sery.id }"> <select class="form-control" id="sery"
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<input id="cat-labels" class="form-control" value="${blog.tagNames }" name="tagNames" placeholder="Create or Search tag"
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<textarea class="form-control richeditor" name="blogDesc" placeholder="Description" rows="6">${blog.blogDesc }</textarea>
			</div>
		</div>
		<div class="form-group">
	...
	<div id="new-section">
		<form role="form" class="form-horizontal well" method="post" action="<c:url value="/section/save"/>">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input class="form-control" name="sectionTitle" type="text" placeholder="Section Title" autofocus required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-2 control-label" for="sectionContent">Content</label>
				<div class="col-lg-10">
					<textarea class="form-control richeditor" name="sectionContent" placeholder="Subtitle" rows="18"></textarea>
				</div>
			</div>
			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
					<input type="submit" class="btn btn-primary" value="Add Section"> <input type="submit" class="btn btn-default" value="Add & New">
				</div>
			</div>
		</form>
	</div>
