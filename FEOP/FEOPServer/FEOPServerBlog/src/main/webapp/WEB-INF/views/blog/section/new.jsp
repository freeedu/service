...
<div>
	...
	<form id="update-section" class="editable" method="put">
		...
		<fieldset class="inputs">
			<label class="input-title" for="section-name">Section Name</label> <input type="text" name="section-name" id="section-name"
				placeholder="Section Name"> <label class="input-title" for="description">Description</label>
