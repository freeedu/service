...
(function($) { "use strict";
    ...
    var Renderer = function() {
        var aToolbarItem = {
            picture:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Picture" data-event="showImageDialog" tabindex="-1"><i class="glyphicon glyphicon-picture"></i></button>',
            link:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Link" data-event="showLinkDialog" data-shortcut="Ctrl+K" data-mac-shortcut="&#8984;+K" tabindex="-1"><i class="glyphicon glyphicon-link"></i></button>',
            table:
                '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="Table" data-toggle="dropdown" tabindex="-1"><i class="glyphicon glyphicon-th"></i> <span class="caret"></span></button>' +
                    ...
                    '</ul>',
            style:
                '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="Style" data-toggle="dropdown" tabindex="-1"><i class="glyphicon glyphicon-pencil"></i> <span class="caret"></span></button>' +
                    '<ul class="dropdown-menu">' +
            ...
            fontsize:
                '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="Font Size" tabindex="-1"><span class="note-current-fontsize">11</span> <b class="caret"></b></button>' +
                    '<ul class="dropdown-menu">' +
                    '<li><a data-event="fontSize" data-value="8"><i class="glyphicon glyphicon-ok"></i> 8</a></li>' +
                    '<li><a data-event="fontSize" data-value="9"><i class="glyphicon glyphicon-ok"></i> 9</a></li>' +
                    '<li><a data-event="fontSize" data-value="10"><i class="glyphicon glyphicon-ok"></i> 10</a></li>' +
                    '<li><a data-event="fontSize" data-value="11"><i class="glyphicon glyphicon-ok"></i> 11</a></li>' +
                    '<li><a data-event="fontSize" data-value="12"><i class="glyphicon glyphicon-ok"></i> 12</a></li>' +
                    '<li><a data-event="fontSize" data-value="14"><i class="glyphicon glyphicon-ok"></i> 14</a></li>' +
                    '<li><a data-event="fontSize" data-value="18"><i class="glyphicon glyphicon-ok"></i> 18</a></li>' +
                    '<li><a data-event="fontSize" data-value="24"><i class="glyphicon glyphicon-ok"></i> 24</a></li>' +
                    '<li><a data-event="fontSize" data-value="36"><i class="glyphicon glyphicon-ok"></i> 36</a></li>' +
                    '</ul>',
            color:
                '<button type="button" class="btn btn-default btn-sm btn-small note-recent-color" title="Recent Color" data-event="color" data-value=\'{"backColor":"yellow"}\' tabindex="-1"><i class="glyphicon glyphicon-font" style="color:black;background-color:yellow;"></i></button>' +
                    ...
                    '</ul>',
            bold:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Bold" data-shortcut="Ctrl+B" data-mac-shortcut="&#8984;+B" data-event="bold" tabindex="-1"><i class="glyphicon glyphicon-bold"></i></button>',
            italic:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Italic" data-shortcut="Ctrl+I" data-mac-shortcut="&#8984;+I" data-event="italic" tabindex="-1"><i class="glyphicon glyphicon-italic"></i></button>',
            underline:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Underline" data-shortcut="Ctrl+U" data-mac-shortcut="&#8984;+U" data-event="underline" tabindex="-1"><b style="text-decoration: underline;">U</b></button>',
            ul:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Unordered list" data-shortcut="Ctrl+Shift+8" data-mac-shortcut="&#8984;+&#8679;+7" data-event="insertUnorderedList" tabindex="-1"><i class="glyphicon glyphicon-list"></i></button>',
            ol:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Ordered list" data-shortcut="Ctrl+Shift+7" data-mac-shortcut="&#8984;+&#8679;+8" data-event="insertOrderedList" tabindex="-1"><i class="glyphicon glyphicon-th-list"></i></button>',
            paragraph:
                '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="Paragraph" data-toggle="dropdown" tabindex="-1"><i class="glyphicon glyphicon-align-left"></i>  <span class="caret"></span></button>' +
                    '<ul class="dropdown-menu">' +
                    '<li>' +
                    '<div class="note-align btn-group">' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="Align left" data-shortcut="Ctrl+Shift+L" data-mac-shortcut="&#8984;+&#8679;+L" data-event="justifyLeft" tabindex="-1"><i class="glyphicon glyphicon-align-left"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="Align center" data-shortcut="Ctrl+Shift+E" data-mac-shortcut="&#8984;+&#8679;+E" data-event="justifyCenter" tabindex="-1"><i class="glyphicon glyphicon-align-center"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="Align right" data-shortcut="Ctrl+Shift+R" data-mac-shortcut="&#8984;+&#8679;+R" data-event="justifyRight" tabindex="-1"><i class="glyphicon glyphicon-align-right"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="Justify full" data-shortcut="Ctrl+Shift+J" data-mac-shortcut="&#8984;+&#8679;+J" data-event="justifyFull" tabindex="-1"><i class="glyphicon glyphicon-align-justify"></i></button>' +
                    '</div>' +
                    '</li>' +
                    '<li>' +
                    '<div class="note-list btn-group">' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="Outdent" data-shortcut="Ctrl+[" data-mac-shortcut="&#8984;+[" data-event="outdent" tabindex="-1"><i class="glyphicon glyphicon-indent-left"></i></button>' +
                    '<button type="button" class="btn btn-default btn-sm btn-small" title="Indent" data-shortcut="Ctrl+]" data-mac-shortcut="&#8984;+]" data-event="indent" tabindex="-1"><i class="glyphicon glyphicon-indent-right"></i></button>' +
                    '</li>' +
                    '</ul>',
            height:
                '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="Line Height" tabindex="-1"><i class="glyphicon glyphicon-text-height"></i>&nbsp; <b class="caret"></b></button>' +
                    '<ul class="dropdown-menu">' +
                    '<li><a data-event="lineHeight" data-value="1.0"><i class="glyphicon glyphicon-ok"></i> 1.0</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.2"><i class="glyphicon glyphicon-ok"></i> 1.2</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.4"><i class="glyphicon glyphicon-ok"></i> 1.4</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.5"><i class="glyphicon glyphicon-ok"></i> 1.5</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.6"><i class="glyphicon glyphicon-ok"></i> 1.6</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.8"><i class="glyphicon glyphicon-ok"></i> 1.8</a></li>' +
                    '<li><a data-event="lineHeight" data-value="2.0"><i class="glyphicon glyphicon-ok"></i> 2.0</a></li>' +
                    '<li><a data-event="lineHeight" data-value="3.0"><i class="glyphicon glyphicon-ok"></i> 3.0</a></li>' +
                    '</ul>',
            help:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Help" data-shortcut="Ctrl+/" data-mac-shortcut="&#8984;+/" data-event="showHelpDialog" tabindex="-1"><i class="glyphicon glyphicon-question-sign"></i></button>',
            fullscreen:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Full Screen" data-event="fullscreen" tabindex="-1"><i class="glyphicon glyphicon-fullscreen"></i></button>',
            codeview:
                '<button type="button" class="btn btn-default btn-sm btn-small" title="Code View" data-event="codeview" tabindex="-1"><i class="glyphicon glyphicon-eye-open"></i></button>'
        };
        var sPopover = '<div class="note-popover">' +
            ...
            '<button type="button" class="btn btn-default btn-sm btn-small" title="Edit" data-event="showLinkDialog" tabindex="-1"><i class="glyphicon glyphicon-edit"></i></button>' +
            '<button type="button" class="btn btn-default btn-sm btn-small" title="Unlink" data-event="unlink" tabindex="-1"><i class="glyphicon glyphicon-remove"></i></button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            ...
            '<div class="btn-group">' +
            '<button type="button" class="btn btn-default btn-sm btn-small" title="Resize Full" data-event="resize" data-value="1" tabindex="-1"><i class="glyphicon glyphicon-resize-full"></i></button>' +
            ...
            '</div>' +
            '<div class="btn-group">' +
            '<button type="button" class="btn btn-default btn-sm btn-small" title="Float Left" data-event="float" data-value="left" tabindex="-1"><i class="glyphicon glyphicon-align-left"></i></button>' +
            '<button type="button" class="btn btn-default btn-sm btn-small" title="Float Right" data-event="float" data-value="right" tabindex="-1"><i class="glyphicon glyphicon-align-right"></i></button>' +
            '<button type="button" class="btn btn-default btn-sm btn-small" title="Float None" data-event="float" data-value="none" tabindex="-1"><i class="glyphicon glyphicon-align-justify"></i></button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>';
